...
class Ihale(models.Model):
    ...
    cetvel_dosya = models.FileField(upload_to='ihaleler/cetveller/', null=True, blank=True, verbose_name="Birim Fiyat Cetveli (PDF/Excel)")
    sartname_dosya = models.FileField(upload_to='ihaleler/sartnameler/', null=True, blank=True, verbose_name="Teknik Şartname (PDF)")
